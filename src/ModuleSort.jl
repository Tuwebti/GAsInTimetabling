function test()
  ...
  ModuleSorted = collect(keys(modules)); #initialising final module order array
  ...
  counting1 = 1 #counting1 tells the loop what module it should currently be checking (increased by 1 on each loop)
  ...
  for sortmod in keys(ModuleSorted[1:end-1]) #looping through all modules
    ...
    while moduleclash[1,sortmod] < moduleclash[1,sortmod+1]
      ...
      temp = moduleclash[sortmod]
      ModuleSorted[sortmod] = ModuleSorted[sortmod+1]
      ModuleSorted[sortmod+1] = temp
    ...
    if moduleclash[1,sortmod] == moduleclash[1,sortmod+1]
      ...
      while moduleclash[2,sortmod] < moduleclash[2,sortmod+1]
        ...
        temp2 = moduleclash[sortmod]
        ModuleSorted[sortmod] = ModuleSorted[sortmod+1]
        ModuleSorted[sortmod+1] = temp2
